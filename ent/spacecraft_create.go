...
func (sc *SpacecraftCreate) SetCrew(u uint32) *SpacecraftCreate {
	sc.mutation.SetCrew(u)
	return sc
}
...
func (sc *SpacecraftCreate) SetNillableImage(s *string) *SpacecraftCreate {
	if s != nil {
		sc.SetImage(*s)
	}
	return sc
...
func (sc *SpacecraftCreate) SetDeleted(b bool) *SpacecraftCreate {
	sc.mutation.SetDeleted(b)
	return sc
}

// SetNillableDeleted sets the "deleted" field if the given value is not nil.
func (sc *SpacecraftCreate) SetNillableDeleted(b *bool) *SpacecraftCreate {
	if b != nil {
		sc.SetDeleted(*b)
	}
	return sc
...
func (sc *SpacecraftCreate) AddArmament(a ...*Armement) *SpacecraftCreate {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
...
func (sc *SpacecraftCreate) defaults() {
	if _, ok := sc.mutation.Deleted(); !ok {
		v := spacecraft.DefaultDeleted
...
func (sc *SpacecraftCreate) check() error {
	...
	if _, ok := sc.mutation.Deleted(); !ok {
		return &ValidationError{Name: "deleted", err: errors.New(`ent: missing required field "Spacecraft.deleted"`)}
	}
	return nil
}
...
func (sc *SpacecraftCreate) createSpec() (*Spacecraft, *sqlgraph.CreateSpec) {
	...
	if nodes := sc.mutation.ArmamentIDs(); len(nodes) > 0 {
