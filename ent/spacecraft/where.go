...
func Crew(v uint32) predicate.Spacecraft {
...
func Deleted(v bool) predicate.Spacecraft {
	return predicate.Spacecraft(sql.FieldEQ(FieldDeleted, v))
}
...
func ImageIsNil() predicate.Spacecraft {
	return predicate.Spacecraft(sql.FieldIsNull(FieldImage))
}

// ImageNotNil applies the NotNil predicate on the "image" field.
func ImageNotNil() predicate.Spacecraft {
	return predicate.Spacecraft(sql.FieldNotNull(FieldImage))
}
...
func DeletedEQ(v bool) predicate.Spacecraft {
	return predicate.Spacecraft(sql.FieldEQ(FieldDeleted, v))
}

// DeletedNEQ applies the NEQ predicate on the "deleted" field.
func DeletedNEQ(v bool) predicate.Spacecraft {
	return predicate.Spacecraft(sql.FieldNEQ(FieldDeleted, v))
}

// HasArmament applies the HasEdge predicate on the "armament" edge.
func HasArmament() predicate.Spacecraft {
...
func HasArmamentWith(preds ...predicate.Armement) predicate.Spacecraft {
	return predicate.Spacecraft(func(s *sql.Selector) {
