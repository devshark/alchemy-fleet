...
type Spacecraft struct {
	...
	Crew uint32 `json:"crew,omitempty"`
...
type SpacecraftEdges struct {
	...
	Armament []*Armement `json:"armament,omitempty"`
...
func (e SpacecraftEdges) ArmamentOrErr() ([]*Armement, error) {
	if e.loadedTypes[0] {
...
// QueryArmament queries the "armament" edge of the Spacecraft entity.
func (s *Spacecraft) QueryArmament() *ArmementQuery {
	return NewSpacecraftClient(s.config).QueryArmament(s)
}
