...
func main() {
	...
	connectionString := fmt.Sprintf("%s:%s@%s:%d/%s?parseTime=True", cfg.Database.Username, cfg.Database.Password, cfg.Database.Host, cfg.Database.Port, cfg.Database.Database)
